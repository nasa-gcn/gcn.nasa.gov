export function DemoData() {
  return [
    {
      subject: 'Fermi GRB 221221A: Global MASTER-Net observations report',
      body: 'V. Lipunov, V.Kornilov, E.Gorbovskoy, K.Zhirkov, N.Tyurina, P.Balanutsa, A.Kuznetsov, D. Vlasenko,\nG.Antipov, D.Zimnukhov, V.Senik, E.Minkina, A.Chasovnikov, V.Topolev, D.Kuvshinov, D.Cheryasov, Ya.Kechin\n(Lomonosov Moscow State University, SAI, Physics Department),\n\nR. Podesta, C.Lopez, F. Podesta, C.Francile\n(Observatorio Astronomico Felix Aguilar OAFA),\n\nR. Rebolo, M. Serra\n(The Instituto de Astrofisica de Canarias),\n\nD. Buckley\n(South African Astronomical Observatory),\n\nO.A. Gres, N.M. Budnev\n(Irkutsk State University, API),\n\nL.Carrasco, J.R.Valdes, V.Chavushyan, V.M.Patino Alvarez, J.Martinez, A.R.Corella, L.H.Rodriguez\n(INAOE, Guillermo Haro Astrophysics Observatory),\n\nA. Tlatov, D. Dormidontov\n(Kislovodsk Solar Station of the Pulkovo Observatory),\n\nA. Gabovich, V.Yurkov\n(Blagoveschensk Educational State University)\n\nMASTER-Tunka robotic telescope (Global MASTER-Net: http://observ.pereplet.ru, Lipunov et al., 2010, Advances in Astronomy, vol. 2010, 30L) located in Russia (Applied Physics Institute, Irkutsk State University) started inspect of the Fermi GRB 221221A ( Fermi GBM team, GCN 33091) errorbox 889 sec after notice time and 900 sec after trigger time at 2022-12-21 22:54:31 UT, with upper limit up to 19.4 mag. The observations began at zenith distance = 50 deg. The sun altitude is -19.6 deg.\n\nThe galactic latitude b = 16 deg., longitude l = 149 deg.\n\nReal time updated cover map and OT discovered available here:\nhttps://master.sai.msu.ru/site/master2/observ.php?id=2186194\n\nWe obtain a following upper limits.\n\n',
      id: 33092,
      createdOn: '22/12/22 01:45:20 GMT',
      submitter:
        'Vladimir Lipunov at Moscow State U/Krylov Obs lipunov@xray.sai.msu.ru',
    },
    {
      subject: 'GRB 221221A: Fermi GBM Final Real-time Localization',
      body: `
      ...
      `,
      id: 33091,
      createdOn: '22/12/21 22:49:56 GMT',
      submitter:
        'Fermi GBM Team at MSFC/Fermi-GBM  <do_not_reply@GIOC.nsstc.nasa.gov>',
    },
    {
      subject: 'GRB 221218A: 3.6m DOT optical upper limit',
      body: `Rahul Gupta, Amit K. Ror, S. B. Pandey, A. Aryan, A. Ghosh, Dimple, and K.
      Misra (ARIES) report:
      ...
      the 3.6m DOT.`,
      id: 33090,
      createdOn: '22/12/21 21:44:51 GMT',
