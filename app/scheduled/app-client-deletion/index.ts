...
export async function handler() {
  ...
  const emailPromises = expiredCredentials.map((cred) =>
    sendEmail({
      ...
      body: `Your Kafka client credential "${cred.name}" has been deleted. For more information about our credential deletion policy, please visit ${origin}/docs/internal/auth or ${origin}/contact for support.`,
    })
  )
