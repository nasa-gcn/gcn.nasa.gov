...
| <div><Icon.Github size="3"/></div> **Open software**                 | <span className="text-red text-bold">NO.</span> Custom software needed to receive notices                                             | <span className="text-green text-bold">YES.</span> Receive notices using [open-source software](/docs/client)                         |
