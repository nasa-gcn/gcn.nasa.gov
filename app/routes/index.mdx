...
<SectionWrapper className="landing-hero bg-base-darkest">
  <div
    id="landing-hero-primary-div"
    className="grid-row usa-hero margin-0 padding-0"
  >
    <div className="tablet:padding-y-4 tablet:padding-right-8 tablet:padding-left-0 tablet:grid-col-5 mobile-lg:padding-4">
...
<SectionWrapper className="padding-bottom-0">
...
<SectionWrapper className="padding-top-0">
## Why switch from GCN Classic to [Kafka](docs/faq#what-is-kafka)?
