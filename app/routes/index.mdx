...
| -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <div><Icon.ConnectWithoutContact size="3"/></div> **Open standards** | <span className="text-red text-bold">NO.</span> Notices are sent using three custom protocols                                         | <span className="text-green text-bold">YES.</span> Notices sent using one standard protocol, [Apache Kafka](https://kafka.apache.org)                                                                                                                                          |
| <div><Icon.Github size="3"/></div> **Open software**                 | <span className="text-red text-bold">NO.</span> Custom software needed to receive notices                                             | <span className="text-green text-bold">YES.</span> Receive notices using open-source software including [confluent-kafka-python](https://github.com/confluentinc/confluent-kafka-python) and [SCiMMA](https://scimma.org)'s [hop-client](https://github.com/scimma/hop-client) |
...
| <div><Icon.Cloud size="3"/></div> **Highly Available**               | <span className="text-red text-bold">NO.</span>                                                                                       | <span className="text-green text-bold">YES.</span> Notices are served by a cluster of highly-available Kafka brokers in the cloud                                                                                                                                              |
