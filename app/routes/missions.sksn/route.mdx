...
- `pipeline`: The analysis pipeline used to generate this alert; either `"snwatch"` or `"wit"`. Both the Supernova watch (SNwatch) and Wide-band Intelligent Trigger (WIT) are online analysis systems. The energy thresholds are 2.5 MeV for SNwatch and 2.5 MeV for WIT, respectively.
