...
## 2024
    ...
    >
      <CollectionHeading headingLevel="h3">
        <Anchor>Circulars are Now Available via Kafka, New Schema Release v4.1.0 and Heartbeat Kafka Topic</Anchor>
      </CollectionHeading>
      <CollectionDescription>
        - **Stream Circulars over Kafka in JSON format** on the topic `gcn.circulars`.  Add Circulars to your existing Kafka streaming codes or generated via the [Start Streaming Interface](/quickstart).
