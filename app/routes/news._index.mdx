...
## 2024
    ...
    <CollectionItem
      className="maxw-none"
      variantComponent={
        <CollectionCalendarDate datetime={'May 28, 2024'} />
      }
    >
      ...
      <CollectionDescription>
        ...
        #### Einstein Probe Notices
          ...
          - Occurrence Rate: The EP notices occur at a rate of ~100 times per year.
        ...
        Explore GCN Schema via the [Schema Browser](/docs/schema/v4.0.0/gcn/notices).  Changes to the GCN Schema include:
          ...
          - Note that each JSON notice references the version of the schema it is utilizing. `gcn.notices.icecube.lvk_nu_track_search` will update on the morning of June 18, 2024, and `gcn.notices.swift.bat.guano` will be updated at a later date.
