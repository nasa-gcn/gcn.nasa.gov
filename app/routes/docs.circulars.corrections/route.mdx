...
import editButtonScreenshot from './edit-button-screenshot.svg'
import versionButtonScreenshot from './version-button-screenshot.svg'
...
3. Select "Edit".
   ...
   <img
     src={editButtonScreenshot}
     alt="Screen shot of Circulars archive menu showing how to request corrections."
     width="424.5"
     height="29.2"
     className="height-auto padding-1 border-05 shadow-5"
   />

4. Edit the Circular as needed and then select "Request Correction".
