...
import { ProducerSampleCode } from '~/components/ProducerSampleCode'
...
<ProcessList>
   ...
   <WithFeature schema>
      <ProcessListItem>
         ...
         As a GCN Notice producer, you have the flexibility to create your own instrument-specific schema. Please contribute your schema to our [GitHub repository](https://github.com/nasa-gcn/gcn-schema), placing it in a folder under <code>gcn/notices/<i>mission</i></code> and submit a pull request for the GCN Team to review. For details, please refer to the [schema design](/docs/producers/schema) documentation for step-by-step instructions.
      </ProcessListItem>
   </WithFeature>
   <ProcessListItem>
      <ProcessListHeading type="h3">
