...
<ProcessList>
   ...
   <ProcessListItem>
      ...
      **Note**: Please indicate the latest schema version i.e. vX.Y.Z. against which the notices for the mission have been validated, rather than referring to the main branch.
