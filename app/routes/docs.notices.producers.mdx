...
<ProcessList>
   ...
   <ProcessListItem>
      ...
      The naming convention for Kafka topics follow the format <code>gcn.notices.<i>mission</i>.<i>NoticesType</i></code>. The mission name should be lower case, while the Kafka topics should be in [CamelCase](https://en.wikipedia.org/wiki/Camel_case) format.
