...
<ProcessList>
   ...
   <ProcessListItem>
      ...
      # Connect as a producer and always remain connected.
      ...
      # When you have an event to report, produce to the topic to generate a Notice
...
<Alert type="info" heading="Produce the Notice" headingLevel="h4">
The producer should always remain connected via `producer = Producer(...)`, with the JSON generation and `producer.produce` commands kicked off by new alerts from your pipeline. If you do not connect to Kafka with your credentials at least monthly, they will expire.  Leaving your alert script running and your Kafka client connected indefinitely ensures that your credentials do not expire and provides the lowest latency.
