...
<Table bordered compact stackedStyle="headers">
  ...
  <tbody>
    ...
    <tr>
      <Key>`ZENDESK_CLIENT_ID`, `ZENDESK_CLIENT_SECRET`</Key>
      <Description>
        [Zendesk API OAuth
        credentials](https://developer.zendesk.com/documentation/api-basics/authentication/api-tokens-to-oauth/#client-credentials-flow)
      </Description>
