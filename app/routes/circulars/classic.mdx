...
<div className="usa-alert usa-alert--warning">
  <div className="usa-alert__body">
    <p className="usa-alert__text">
      This page will be updated on April 17, 2023. See [news and
      announcements](/news) for more information.
    </p>
  </div>
</div>
...
You can request access through the [sign up page](https://gcn.gsfc.nasa.gov/gcn_circ_signup.html). There are no restrictions to being added to the list. It is recommended that you contact the [GCN Team](https://heasarc.gsfc.nasa.gov/cgi-bin/Feedback?selected=kafkagcn).

## Submission process

To submit a GCN Circular send an email to gcncirc@capella2.gsfc.nasa.gov.
