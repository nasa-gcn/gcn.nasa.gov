...
<Collection>
  ...
  >
    ...
    <CollectionDescription>
      Email Notification self sercive will greatly simplify and enhance the user
      experience for subscribing to GCN Notices. Using the same accounts on the
      General Coordinates Network as GCN Classic Over Kafka, users can now sign
      up to subscribe to any of the public GCN Notice types in any of the 3
      legacy formats (text, binary, VOEvent), and edit their settings at will.
      Signing up here does not edit prior subscriptions to GCN Classic. When you
      would like to unsubscribe from GCN Classic, [please contact
