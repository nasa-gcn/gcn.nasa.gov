...
<Collection>
  ...
  <CollectionItem
    variantComponent={
      <CollectionCalendarDate datetime={'April 12, 2023'} />
    }
  >
    <CollectionHeading headingLevel="h3">
      New GCN Circulars Service Coming April 12, 2023
    </CollectionHeading>
    <CollectionDescription>
     We are pleased to announce that on April 12, 2023, the General Coordinates Network will launch the most significant overhaul of GCN Circulars since its inception in 1997. The modernized GCN Circulars experience will be part of the new GCN web site at https://gcn.nasa.gov/circulars.
     After the transition on April 12, you will be able to:
      ...
      - April 13, 2023 12:00-13:00 UTC (best for Atlantic):
        Link

      - April 13, 2023 20:00-21:00 UTC (best for Pacific):
        Link

      - April 13, 2023 04:00-05:00 UTC (best for Asia and Oceania):
        Link
    </CollectionDescription>
