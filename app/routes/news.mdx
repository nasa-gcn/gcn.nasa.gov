...
<Collection>
  ...
  >
    ...
    <CollectionDescription>
      GCN now distributes notices from the [GECAM](https://gcn.nasa.gov/missions/gecam) mission. Start streaming GECAM notices using [GCN Classic over Kafka](/quickstart), have them [delivered to your email inbox using self-service email subscriptions](#Self-Service-Configuration-of-Email-Notifications-for-GCN-Notices), or 
receive them as legacy notices using GCN Classic. To modify GCN
