...
<Collection>
  ...
  >
    ...
    <CollectionDescription>
      ...
      [GECAM Notices](https://gcn.nasa.gov/missions/gecam). GECAM notices are
      available via GCN Classic Over Kafka, and the newly released [self-service
      configuration of GCN Notices over
      email](#Self-Service-Configuration-of-Email-Notifications-for-GCN-Notices)
      as well as GCN Classic distribution methods and formats (binary socket,
      VOEvent xml socket, text via email and SMS). To unsubscribe or edit GCN
      Classic subscriptions, please [contact
