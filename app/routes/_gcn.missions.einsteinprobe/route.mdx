...
| -------------------------- | ------------ | -------------------- | ---------------------- |
| Wide Field X-ray Telescope | 0.5 – 5 keV  | 3600 deg<sup>2</sup> | 5 arcmin (FWHM)        |
...
| -------------------------------------- | -------------------------------------- | ------- |
| `gcn.notices.einstein_probe.wxt.alert` | Localization, Count Rate, Significance | ??      |
...
| ---------- | ------------------------------------------------------ | ----- |
| WXT        | GRBs, other transients, and non-astrophysical triggers | ??    |
