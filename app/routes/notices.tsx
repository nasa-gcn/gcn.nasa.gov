  ...
  return (
    <>
      <SectionWrapper>
        <h1>GCN Notices</h1>
        <p>
          GCN Notices are real-time, machine-readable alerts that are submitted
          by participating facilities and redistributed publicly.
        </p>
        ...
        <CardGroup>
          ...
          <NoticeCard
            ...
            selectedTags={tagNames}
          >
            Non-GRB gamma-ray transients detected by the LAT instrument on
            Fermi.
          </NoticeCard>
          <NoticeCard
            name="Swift GRBs"
