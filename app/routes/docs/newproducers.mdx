...
1. Make sure that all of the producer users (who will enable GCN notices in your pipelines)
   have signed in (at least once) to https://test.gcn.nasa.gov and https://gcn.nasa.gov.
2. Please send the [GCN Team](https://heasarc.gsfc.nasa.gov/cgi-bin/Feedback?selected=kafkagcn)
   a list of email addresses of all the people who should have the
   producer access to the MissionName.\* topics.
3. Log out and log back in.
4. Go through the "Start Streaming GCN Notices" process.
5. On Step 2 of "Start Streaming GCN Notices", choose the scope gcn.nasa.gov/kafka-MissionName-producer.
6. Your producer code will look very similar to the client example code.
