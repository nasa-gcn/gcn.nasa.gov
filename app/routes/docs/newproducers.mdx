...
1. Make sure that your team member(s) who will implement GCN notices in your pipeline
...
7. Your producer code will look very similar to the [client example code](docs/client) and
