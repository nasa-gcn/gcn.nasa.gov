...
We have built a set of core schema which serves as the building blocks for
your Notices. You can also define instrument-specific quantities in your
...
# Connect as a producer. <br>
# Warning: don't share the client secret with others.
producer = Producer(client_id='fill me in', _secret='fill me in')
...
Add mission page linking to relevant information and archives, and description of
new GCN notices content. GCN Team is also available to help construct and format
the mission page.
