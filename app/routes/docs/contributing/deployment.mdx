...
import deploymentScreenshot from '~/img/deployment-screenshot.png'
...
<table className="usa-table">
  ...
  <tbody>
    <tr>
      <td>
        Development
        <Link to="https://dev.gcn.nasa.gov/" className="text-no-wrap">
          dev.gcn.nasa.gov
        </Link>
      </td>
    ...
    <tr>
      <td>
        Testing
        <Link to="https://test.gcn.nasa.gov/" className="text-no-wrap">
          test.gcn.nasa.gov
        </Link>
      </td>
    ...
    <tr>
      <td>
        Production
        <Link to="https://gcn.nasa.gov/" className="text-no-wrap">
          gcn.nasa.gov
        </Link>
      </td>
