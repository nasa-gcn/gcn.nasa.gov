...
>
  The [GCN Classic VOEvent brokers](https://gcn.gsfc.nasa.gov/voevent.html) were
  retired on April 6, 2026. VOEvent-format Notices are still available via
  [Kafka and email](notices/consuming).
</Alert>
