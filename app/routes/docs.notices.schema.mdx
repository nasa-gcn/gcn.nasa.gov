...
## Recommended Schema and Examples

We recommend exploring our [schema browser](/docs/schema/stable/gcn/notices) and [GitHub repository](https://github.com/nasa-gcn/gcn-schema/tree/main/gcn/notices) for more examples.

Here is an example of the minimum recommended schema for a transient discovery instrument:

<Tabs>
  <Tab label="discovery.schema.json">
    <Highlight
      language="json"
      code={JSON.stringify(
        {
          $id: 'https://gcn.nasa.gov/schema/main/gcn/notices/LISA/discovery.schema.json',
          $schema: 'https://json-schema.org/draft/2020-12/schema',
          title: 'Recommended schema for discovery instruments',
          description:
            'This is a basic transient discovery instrument schema template.',
          type: 'object',
          allOf: [
            {
              $ref: '../core/Alert.schema.json',
          ...
          required: ['alert_datetime', 'mission'],
          properties: {
            subtype: {
              enum: ['type_1', 'type_2', 'type_3'],
              description:
                'Subtype is required, when a single schema is used to produce multiple variations of a notice.',
            },
          },
        },
        null,
  ...
  <Tab label="discovery.example.json">
    <Highlight
      language="json"
      code={JSON.stringify(
        {
          $schema:
            'https://gcn.nasa.gov/schema/main/gcn/notices/LISA/discovery.schema.json',
          alert_datetime: '2040-02-29T00:00:00Z',
          mission: 'LISA',
          subtype: 'type_1',
          alert_type: 'initial',
          trigger_time: '2040-02-28T12:00:00Z',
          ra: 60.0,
          dec: 42.0,
          ra_dec_error: 0.02,
          instrument: 'Space Observatory',
          messenger: 'GW',
          event_name: 'GW400228',
          id: '0123456',
          record_number: 1,
...
This template serves as a starting point, such that all essential properties are included.

For drafting the follow-up notices of discovery instrument, below is the recommended minimum schema with an example:

<Tabs>
  <Tab label="follow_up.schema.json">
    <Highlight
      language="json"
      code={JSON.stringify(
        {
          $id: 'https://gcn.nasa.gov/schema/main/gcn/notices/LISA/follow_up.schema.json',
          $schema: 'https://json-schema.org/draft/2020-12/schema',
          title: 'Recommended Schema for follow-up observations',
          description: 'This is basic follow-up instrument schema template.',
          type: 'object',
          allOf: [
            {
          ...
          required: ['mission', 'ref_instrument'],
          properties: {
            subtype: {
              enum: ['type_1', 'type_2', 'type_3'],
              description:
  ...
  <Tab label="follow_up.example.json">
    <Highlight
      language="json"
      code={JSON.stringify(
        {
          $schema:
            'https://gcn.nasa.gov/schema/main/gcn/notices/LISA/follow_up.schema.json',
          ref_type: 'GW',
          ref_instrument: 'LISA Space Observatory',
          ref_ID: '0123456',
          subtype: 'type_1',
          alert_type: 'initial',
          ra: 60.0,
