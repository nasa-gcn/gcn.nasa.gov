...
The Git repository is configured to automatically format and validate your code at the time that you commit it. This means when you commit your updates, the validator will run to make sure that all of the schemas and their respective examples function correctly. This step also checks general formatting using the [Prettier](https://prettier.io/) formatter. To quickly format your code, run the following command in the root directory of your local repository. This will format spacing, line-breaks, etc. as needed.
