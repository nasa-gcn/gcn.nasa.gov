...
<ProcessList>
  <ProcessListItem>
    <ProcessListHeading type="h3">Fork the GitHub Repository</ProcessListHeading>
    ...
    <Tabs>
      ...
      <Tab label="Sample.example.json">
        <Highlight
          ...
          code={JSON.stringify(
            {
              $schema:'https://gcn.nasa.gov/schema/main/gcn/notices/<mission>/<schema name>.schema.json',
  ...
  <ProcessListItem>
    <ProcessListHeading type="h3">Defining Schema</ProcessListHeading>
      ...
      While defining JSON schema structures, please don't hesitate to reach out with any questions about Schema field definitions or specific fields you are looking for.
  </ProcessListItem>
  <ProcessListItem>
