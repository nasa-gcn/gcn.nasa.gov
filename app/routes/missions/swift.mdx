...
import logo from '~/img/logo_swift.gif'
...
These notices are published on the GCN Kafka topic **swift.bat.guano**.
[Detailed Description and Examples](https://gcn.nasa.gov/schema/gcn/notices/swift/bat/guano/alert.schema.json)

<div className="overflow-table">
  | Type | Contents | Latency |
  |-------------|---------------------------------------|----------------| |
  Alert | Detection of a burst | 5 min - 5 hours| | Localization| Arcminute
  position or HEALPix map | 4 hours - 8 hours| | Retraction | Retraction of an
  alert or localization| 4 hours - 1 day|
</div>
