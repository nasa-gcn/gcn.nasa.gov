...
These are bursts that did not result in any of the automatic GCN Notices described above, and is the result of computationally expensive offline analysis.
