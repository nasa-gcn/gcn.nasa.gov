...
import kagra_logo from '~/img/kagra-logo.png'
import lsc_logo from '~/img/lsc-logo.png'
import virgo_logo from '~/img/virgo-logo.png'
...
>
  <img src={lsc_logo} alt="LIGO logo" />
  <img src={virgo_logo} alt="Virgo logo" />
  <img src={kagra_logo} alt="KAGRA logo" />
</div>
