...
## 2025
    ...
    >
      ...
      <CollectionDescription>
        #### GCN Classic Outage
        Due to planned network maintenance at GSFC, the connections to GCN Classic will have loss of network connectivity on Thursday, October 2 from 6 pm ET (22:00 UTC) until 10 pm ET (2:00 UTC October 3). This affects the following GCN services:
          - GCN Classic Notices distribution via socket, VOEvent, and email
          - GCN Classic Notices web site archive
          - GCN Classic-to-Kafka connection and distribution of Notices via Kafka and email, however JSON-format and SVOM VOEvent Notices distribution via GCN Kafka will be unaffected
        #### Potential U.S. Government Shutdown Impact
        [Does GCN keep working during a U.S. federal government shutdown?](https://gcn.nasa.gov/docs/faq#does-gcn-keep-working-during-a-us-federal-government-shutdown)
        ...
        Yes. During a U.S. federal government shutdown, all GCN services (GCN Circulars, GCN Notices, Kafka cluster, the web site) remain fully operational. However, there may be the following minor impacts to GCN users:
          ...
          - Review of Circulars edit requests may be delayed.
