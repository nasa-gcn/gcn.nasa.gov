...
## 2025
    ...
    >
      ...
      <CollectionDescription>
        ...
        - [Schema v4.4.0](/news#schema-v440)
        ...
        ### Schema v4.4.0
        GCN Schema v4.4.0 is available with recent changes including the generic high-energy neutrino and fast radio burst schema ([Release Notes](https://github.com/nasa-gcn/gcn-schema/releases/tag/v4.4.0)).
