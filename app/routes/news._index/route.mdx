...
<CollectionItem
    ...
    variantComponent={
      <CollectionCalendarDate datetime='June 9, 2026' />
    }
>

    <CollectionHeading headingLevel="h3">
      <Anchor>New MAXI Notices and Schema v7.1.0</Anchor>
    </CollectionHeading>
    <CollectionDescription>
      ...
      The GCN Team is pleased to announce new Notice Types and a schema release.
        ...
        - [Schema v7.1.0](/news#schema-v710)
      ...
      #### Schema v7.1.0
      GCN Schema v7.1.0 is available with recent changes including new Notice types ([Release Notes](https://github.com/nasa-gcn/gcn-schema/releases/tag/v7.1.0)).
