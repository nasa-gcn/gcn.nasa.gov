...
## 2025
    ...
    >
      <CollectionHeading headingLevel="h3">
        <Anchor>Circulars Archive Viewable by Event </Anchor>
      </CollectionHeading>
      <CollectionDescription>
        The Circulars archive now provides two options for viewing and searching:
          ...
          - Events View
            ...
            - Search by eventID (e.g. GRB 250101A)
            - Astronomically-associated events with multiple names (e.g. GRB 250101A, EP250101a) will be manually associated into event groups by the GCN Team.  All Circulars associated with any member of the event group will be listed in that Event View and can be searched by any member of that group.  If you would like to suggest event names that should be in the same event group, please [contact the GCN Team](/support).
