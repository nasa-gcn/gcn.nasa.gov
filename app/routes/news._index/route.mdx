...
## 2025
    ...
    >
      ...
      <CollectionDescription>
        The CHIME Team and the GCN team are pleased to announce the availability of CHIME notice types via the [new GCN](https://gcn.nasa.gov) in JSON format.  These notices can be streamed via [Kafka](https://gcn.nasa.gov/quickstart).  They are not available via GCN Classic.
