...
## 2025
    ...
    <CollectionItem
      ...
      variantComponent={
        <CollectionCalendarDate datetime='August 7, 2025' />
      }
    >
      ...
      <CollectionDescription>
          ...
          Super-Kamiokande Summary: Also known as Super-K or SK, [Super-Kamiokande](https://www-sk.icrr.u-tokyo.ac.jp/en/sk/) is a neutrino observatory built by the Japanese Ministry of Education, Science, Sports and Culture with a contribution from the US Department of Energy. Designed to understand the nature of neutrinos, Super-K is a leading detector in the search for MeV neutrino detections of core-collapse supernovae.
          ...
          #### Schema v4.5.0
          GCN Schema v4.5.0 is available with recent changes including the Super-Kamiokande schema and examples ([Release Notes](https://github.com/nasa-gcn/gcn-schema/releases/tag/v4.5.0)).
