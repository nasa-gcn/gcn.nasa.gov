...
>
    ...
    <CollectionDescription>
      ...
      #### DSA-110 Fast Radio Burst Notices
        ...
        DSA-110 notices provide FRB detection and localization distributed on the topic `gcn.notice.dsa110.frb`.

        See the [DSA-110 mission page](/missions/dsa_110) for a more extensive description of the information provided in these new notices.
