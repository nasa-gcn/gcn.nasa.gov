...
## 2025
    ...
    <CollectionItem
      ...
      variantComponent={
        <CollectionCalendarDate datetime={'April 14, 2025'} />
      }
    >
      <CollectionHeading headingLevel="h3">
        <Anchor>New Circulars Sorted by Event </Anchor>
      </CollectionHeading>
      <CollectionDescription>
        The Circulars archive now provides two options for viewing and searching:
          - Circulars View
            - Standard view of Circulars sorted inversely by Circular ID.
            - Search bar searches for text strings (e.g. 250101A) or Circulars numbers (e.g. 12345).
          - Events View
            - Lists astronomical events (e.g. GRB250101A, S250101, EP250101a) with toggle to show all Circulars associated with that event and a link to a page that lists all Circulars in sequence similar to the GCN Classic Circulars Archive.
            - Search by eventID (e.g. GRB250101A)
            - Events with multiple names (e.g. GRB250101A, EP250101a) will be manually associated by the GCN Team as warranted by the astronomical association into groups.  All Circulars associated to any member of the event group will be listed in that Event View and can be searched by any member of that group.  To suggest associations, please [contact the GCN Team](/support).
        See [additional documentation](/docs/circulars/archive) on Event View, EventIDs, and Synonym Groups.
      </CollectionDescription>
    </CollectionItem>
