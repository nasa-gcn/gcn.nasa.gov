...
## 2025
    ...
    <CollectionItem
      ...
      variantComponent={
        ...
        <CollectionCalendarDate datetime='December 3, 2025' />
      }
    >
      <CollectionHeading headingLevel="h3">
        <Anchor>DSA-110 FRB JSON Notices and Schema v6.0.0</Anchor>
      </CollectionHeading>
      <CollectionDescription>

          #### New DSA-110 FRB JSON Notices
          ...
          #### Schema v6.0.0
          GCN Schema v6.0.0 is available with recent changes including the DSA-110 schema ([Release Notes](https://github.com/nasa-gcn/gcn-schema/releases/tag/v6.0.0)).
      </CollectionDescription>
    </CollectionItem>
