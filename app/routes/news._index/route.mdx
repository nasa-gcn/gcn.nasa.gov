...
## 2025
    ...
    <CollectionItem
      ...
      variantComponent={
        ...
        <CollectionCalendarDate datetime='August 25, 2025' />
      }
    >
      ...
      <CollectionDescription>
          ...
          The Super-Kamiokande Team and the GCN team are pleased to announce the availability of Super-Kamiokande notice types via the [new GCN](https://gcn.nasa.gov) in JSON format.  These notices can be streamed via [Kafka](https://gcn.nasa.gov/quickstart).  [SK_SN](https://gcn.gsfc.nasa.gov/sk_sn.html) notices remain available via GCN Classic and GCN Classic over Kafka.  The information included in the JSON-format Notices largely overlap with those in GCN Classic with some additional parameters: the number of detected inverse beta decay (IBD) events, the analysis pipeline used (snwatch or wit), and the type of processed sample (full or partial) used for event detection.
          ...
          A more extensive description of the information provided in these new notices is available at https://gcn.nasa.gov/missions/sksn
