...
### IceCube Single Neutrino Alert Schema

#### topic = gcn.notices.icecube.single_neutrino_alerts

IceCube Single Neutrino Alerts (Gold/Bronze) now follow this [GCN schema](/schema/stable/gcn/notices/icecube/single_neutrino_alerts.example.json) structure.
