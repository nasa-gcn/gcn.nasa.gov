...
The system allows rapid notification of the multimessenger community about likely astrophysical neutrino track-like events detected by IceCube, initiating follow-ups to detect source candidates. A major breakthrough occurred in September 2017, when a neutrino with an energy of approximately 300 TeV (IC-170922A) was found in spatial and temporal coincidence with the flaring blazar TXS 0506+056. This association, supported by gamma-ray data from Fermi-LAT, had a significance of ~3sigma [@2018Sci...361.1378I]. This marked the first compelling multimessenger association between a neutrino and an astrophysical object, providing evidence that blazars can act as cosmic-ray accelerators. Archival analysis revealed a possible earlier neutrino flare from the same source between September 2014 and March 2015, with a significance of 3.5sigma independent of the 2017 alert [@2018Sci...361.1378I]. These observations highlight the potential of real-time multimessenger astronomy.
