...
The neutrino effective areas for these combined selections, for both through-going and starting events, are shown in Figure 1 of [^7]. Astrophysical neutrino-generated tracks selected by these selections are expected to have very good angular resolution. The median angular resolution for these events as a function of energy is shown in Figure 2 of [@2023ApJS..269...25A].
