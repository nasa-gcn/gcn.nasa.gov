...
In 2019, the real-time framework for track-like events was upgraded to improve event selection and alert message content (see [https://gcn.gsfc.nasa.gov/doc/IceCube_High_Energy_Neutrino_Track_Alerts.pdf](https://gcn.gsfc.nasa.gov/doc/IceCube_High_Energy_Neutrino_Track_Alerts.pdf)) [@2023ApJS..269...25A].
