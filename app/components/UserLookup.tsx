...
const UserLookupComboBox = forwardRef<UserComboBoxHandle, UserComboBoxProps>(
  ({ disabled, className, group, onChange, ...props }, ref) => {
...
UserLookupComboBox.displayName = 'UserLookupComboBox'
export default UserLookupComboBox
