...
# array([[-3.89219421, -4.17406822, -4.42613928, -4.64657634, -4.83377889],
...
# lat.degrees
# array([-7.34620853, -3.5319745 ,  0.292994  ,  4.11759842,  7.93070336])
...
def test_burstcube_ephem_latitude():
    ...
    assert (
        abs(
            eph.latitude.deg
            - np.array([-7.34620853, -3.5319745, 0.292994, 4.11759842, 7.93070336])
        )
        < 0.3 / 3600
    ).all()
...
#
# sunra
# array([280.55657134, 280.55756145, 280.55856877, 280.55959297,
#        280.56063359])
# sundec = sunpos.apparent().radec()[0]._degrees
#
# sundec
# array([-23.07915326, -23.07916203, -23.07918388, -23.07921822,
#       -23.07926433])
...
# array([159.77137018, 159.79223935, 159.80612276, 159.81296941, 159.81277874])
#
# moonpos.apparent().radec()[1]._degrees
# array([12.84719405, 12.79202216, 12.73641424, 12.68073706, 12.62535993])
